    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelText: "Email",labelStyle: TextStyle(fontSize: 15,fontWeight: FontWeight.w800),
          //suffixText: '*',suffixStyle: TextStyle(fontSize: 15,fontWeight: FontWeight.w800,color: Colors.red),
        ),
          ...
          Expanded(
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                labelText: "Password",labelStyle: TextStyle(fontSize: 15,fontWeight: FontWeight.w800),
                //suffixText: '*',suffixStyle: TextStyle(fontSize: 15,fontWeight: FontWeight.w800,color: Colors.red),
              ...
              {
                return "must have 5-10 characters";
              }
              else if(!(value.contains(RegExp(r'[0-9]'))))
              {
                return "atleast one numeric";
              }
